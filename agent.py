...
class LearningAgent(Agent):
    ...
    def __init__(self, env, learning=False, epsilon=1.0, alpha=0.5):
        ...
        self.num_trials = 0      # Initialized count for epsilon decay in reset()
    ...
    def reset(self, destination=None, testing=False):
        ...
        if self.testing:
            ...
            if self.learning:
                #self.epsilon -= 0.05
                self.epsilon = math.exp(-0.02*(self.alpha * self.num_trials-200 ))
        return None
    ...
    def build_state(self):
        ...
        '''The specific reason it's not important to consider the 'Right' feature is because according to the USA right of way rules,
        we never need to know what the vehicle to our right is doing.'''
